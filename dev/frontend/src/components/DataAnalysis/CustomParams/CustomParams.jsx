...
const CustomParams = ({ setImage, setSelectChart, selectedChart }) => {
    ...
    return (
        <>
            ...
            {selectedChart === 'scatter' &&
                <Scatter setImage={setImage} />
            }
            {selectedChart === 'histogram' &&
                <Histogram setImage={setImage} />
            }
            {selectedChart === 'boxhidediagram' &&
                <Boxhidediagram setImage={setImage} />
            }
            {selectedChart === 'pieChart' &&
                <PieChart setImage={setImage} />
            }
        </>
    );
};
